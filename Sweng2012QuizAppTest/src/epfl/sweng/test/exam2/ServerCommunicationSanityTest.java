...
public class ServerCommunicationSanityTest extends AndroidTestCase {
	...
	public void testInterfaceImplementation() {
		...
		assertEquals(
				"epfl.sweng.servercomm.search.DefaultQuestionSearchCommunication",
				className);
	}

	public void testSearchByOwner() throws CommunicationException {
		List<QuizQuestion> questions = questionSearch
				.getQuestionsByOwner("joe");
		assertTrue(questions.size() == 2);
	}

	public void testSearchByTag() throws CommunicationException {
		List<QuizQuestion> questions = questionSearch.getQuestionsByTag("tag");
		assertTrue(questions.size() == 2);
	}
